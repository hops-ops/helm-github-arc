...
PACKAGE ?= helm-github-arc
XRD_DIR := apis/githubarcs
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/githubarcs/standard.yaml
...
EXAMPLES := \
    examples/githubarcs/minimal.yaml:: \
    examples/githubarcs/standard.yaml::
...
render\:%:
	@example="examples/githubarcs/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
